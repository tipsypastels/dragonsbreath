...
var CommandOutputBuilder = /** @class */ (function () {
    ...
    CommandOutputBuilder.prototype.yieldEachLine = function (callback) {
        var _a = this.command, children = _a.children, transpiler = _a.transpiler;
    ...
    CommandOutputBuilder.prototype.eachChild = function (callback) {
        var _this = this;
        this.command.children.forEach(function (child, index) {
            callback(child, index, _this);
        });
        return this;
    };
