...
var GiveMon = /** @class */ (function (_super) {
    ...
    GiveMon.prototype.render = function () {
        this.assertParams('constant', 'number', { optional: 'constant' }, { optional: 'constant' }, { optional: 'constant' }, { optional: 'number' });
        var _a = this.parameters, species = _a[0], level = _a[1], item = _a[2], unk1 = _a[3], unk2 = _a[4], unk3 = _a[5];
        var outputParams = [
            this.param(species),
            this.param(level),
