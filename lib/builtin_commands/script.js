...
exports.DRAGONSBREATH_SCRIPT_MAGIC_COMMENT = 'Dbr-output';
/**
...
var Script = /** @class */ (function (_super) {
    ...
    Script.prototype.render = function () {
        ...
        this.assertChildren()
            .assertParams('token');
        this.output
            .addLine(this.parameters[0].value + ":: @ " + exports.DRAGONSBREATH_SCRIPT_MAGIC_COMMENT)
            .yield()
            .addLineIf(this.children[this.children.length - 1].command !== 'return', 'end');
        this.subscripts.forEach(function (subscript) {
            var _a;
            var shouldAddEndAfter = subscript.type === 'code'
                && !subscript.texts[subscript.texts.length - 1].match(/^\s*return\s*$/);
            (_a = _this.output
                .addLine(subscript.name + ":" + (subscript.type === 'code' ? ':' : '') + " @ " + exports.DRAGONSBREATH_SCRIPT_MAGIC_COMMENT)).addLine.apply(_a, subscript.texts).addLineIf(shouldAddEndAfter, 'end')
